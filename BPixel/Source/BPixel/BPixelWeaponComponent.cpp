...
{
	AController* Component = Character->GetController();
	
	if (Character == nullptr || !Component)
	{
		return;
	}
	...
	if (ProjectileClass)
	{
		...
		if (World != nullptr)
		{
			APlayerController* PlayerController = Cast<APlayerController>(Component);
...
bool UBPixelWeaponComponent::AttachWeapon(ABPixelCharacter* TargetCharacter)
{
	...
	if (APlayerController* PlayerController = Cast<APlayerController>(Character->GetController()))
	{
		...
		{
			// Fire
			EnhancedInputComponent->BindAction(FireAction, ETriggerEvent::Triggered, this, &UBPixelWeaponComponent::Fire);
		}
	}
